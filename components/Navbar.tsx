...
const Links = ['Explore', 'Resources', 'Create'];
        ...
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          <Box>
                <Image
                  ...
                  boxSize='50px'
                  alt='Chainwhiz'
                  src={'https://drive.google.com/uc?id=1ynrYezSIfaHP8lLzgnhirH-OshPD5_fv'}>
                </Image>
          </Box>
            ...
            <HStack
              ...
              { !address ? (
                ...
                <MenuList alignItems={'center'}>
                  ...
                  <br />
                  <MenuDivider />
                  <MenuItem onClick={() => handleGenerate()}>Profile</MenuItem>
